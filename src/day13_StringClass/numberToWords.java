    ...
    public static void main(String[] args) {
        ...
        switch (num) {
            ...
            case 9:
                ...
                break;
            default:
                result = "Invalid entrance bitch";

        }
        System.out.println(result);

        String result2 = (num==0)? "Zero":(num==1)?  "Two" : (num==3)? "Three":
                (num==4)? "Four":(num==5)?  "Five" : (num==6)? "Alty":
                (num==7)? "Seven":(num==8)?  "Sakkiz" : (num==9)? "Nine":"Invalid Bitch";
